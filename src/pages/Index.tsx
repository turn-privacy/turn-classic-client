        ...
        <div className="container mx-auto px-4 py-12 flex flex-col lg:flex-row items-center justify-center gap-12">
          <div className="lg:w-1/2">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              Turn Network is a CoinJoin style protocol which allows you to mix
              your assets with those of other users. It takes advantage of the
              UTxO model employed by Cardano to break the link between inputs
              and outputs.
            </p>
